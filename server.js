...
// Exercise 1: GET route for Home Page
app.get('/', (req, res) => {
    res.render('home', { restaurant: RESTAURANT });
});

// Exercise 2: GET route for Full Menu Page
app.get('/menu', (req, res) => {
  res.render('menu', { menu: RESTAURANT.menu });
});

// Exercise 3: GET route for a specific menu category
...
res.render('category', { category: categoryName, menuItems: menuItems });
});
